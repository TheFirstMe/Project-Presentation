...
\title[Automated Answer Paper Evaluation]{Automated Answer Paper Evaluation System} % The short title appears at the bottom of every slide, the full title is only on the title page
...
%	PRESENTATION SLIDES
%------------------------------------------------
\input{Section 1/Project Objectives.tex}
\input{Section 1/mot.tex}
\input{Section 2/Functional Requirements.tex}
\input{Section 4/Project Preliminary Design.tex}
\input{Section 3/Non-Functional Requirements.tex}
\input{Section 6/gantt.tex}
